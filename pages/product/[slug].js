            ...
            <section className="text-gray-400 bg-gray-900 body-font overflow-hidden">
                <div className="container px-5 py-24 mx-auto">
                    <div className="lg:w-4/5 mx-auto flex flex-wrap">
                        <Image alt={"ecommerce"} width={100} height={100} className="lg:w-1/3 w-full lg:h-auto h-64 object-cover object-center rounded" src={product.image} />
                        <div className="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
                            ...
                            <div className="flex mb-4">
                                <span className="flex items-center">
                                    ...
                                    <span className="ml-3">{product.rating} Reviews</span>
                                </span>
                                ...
                                <div className="flex items-center">
                                    ...
                                    <div className="relative">
                                        <select className="rounded border border-gray-700 focus:ring-2 focus:ring-indigo-900 bg-transparent appearance-none py-2 focus:outline-none focus:border-indigo-500 text-white pl-3 pr-10">
                                            <option className='bg-slate-900 text-white'>SM</option>
                                            <option className='bg-slate-900 text-white'>M</option>
                                            <option className='bg-slate-900 text-white'>L</option>
                                            <option className='bg-slate-900 text-white'>XL</option>
                                        </select>
                                    ...
                                    <div className="text-white font-bold">Hurry up, Only {product.countInStock} left !!</div>
                                </div>
                            </div>
                            <div className="flex">
